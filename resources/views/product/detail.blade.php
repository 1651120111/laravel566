                            ...
                            <div class="product-content">
                                ...
                                <div class="rating-price">
                                    ...
                                    if( $productDetail->pro_total > 0 )
                                     $ageDetail = round($productDetail->pro_total_number/$productDetail->pro_total,1);
                            ...
                            <div class="component-rating-content" style="display: flex;font-size:15px;align-items: center;display: flex;align-items: center;border: 1px solid #dedede;border-radius: 5px">
                                <div class="rating-item" style="width: 20%;text-align: center;position: relative">
                                    <div><span class="fa  fa fa-star" style="font-size: 100px;color: #ff9705;"></span>
                                        <b style="position: absolute;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);color: white;font-size: 25px   ">{{$ageDetail}}</b></div>
                                </div>
                                <div class="list_rating" style="width: 60%;padding: 15px">
                                   @foreach($arrayRatings as $key => $value)
                                       <?php

                                            $itemAge = round($value['total']/$productDetail->pro_total*100);
                                        ...
                                        <div class="item_rating" style="display: flex;align-items: center">
                                            ...
                                            <div style="width: 70%;margin:0 20px">
                                                <span style="width: 100%;height: 8px;display: block;border: 1px solid#dedede"><b style="width: {{$itemAge}}%;background-color: red;border-radius: 5px;display: block;height: 100%"></b></span>
                                            </div>
                                            <div style="width: 20%">
                                                <a href=""> {{$value['total']}} đánh giá ({{$itemAge}}%)</a>
                                            </div>
                        ...
                        <div class="component_list_rating" >
                               ...
                               @if($ratings)
                                ...
                                <div class="rating_item" style="margin: 10px 0">
                                    <div>
                                        <span style="color: #333;font-weight: bold;text-transform: capitalize;margin-right: 2%">{{ isset($rating->user->name) ? $rating->user->name :'[N/A]' }}</span>
                                        <a href="" style="color: #00b26f"><i  class="fa fa-check-circle-o"></i>Đã mua hang tai website</a>
                                    </div>
                                    <p style="margin-bottom: 0" class="rating-price">
