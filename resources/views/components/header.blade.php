    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12 text-center nopadding-right">
                <div class="top-logo">
                    <a href="{{route('home')}}"><img src="{{URL::asset("img/logo.gif")}}" alt="" /></a>
                </div>
            </div>
                                    ...
                                    <ul class="cart-list">
                                        <li>
                                            <a class="sm-cart-product" href="product-details.html">
                                                <img src="{{URL::asset("img/products/sm-products/cart1.jpg")}}" alt="">
                                            </a>
                                            <div class="small-cart-detail">
                                                <a class="remove" href="#"><i class="fa fa-times-circle"></i></a>
                                                <a href="#" class="edit-btn"><img src="{{URL::asset("img/btn_edit.gif")}}" alt="Edit Button" /></a>
                                        ...
                                        <li>
                                            <a class="sm-cart-product" href="product-details.html">
                                                <img src="{{URL::asset("img/products/sm-products/cart2.jpg")}}" alt="">
                                            </a>
                                            <div class="small-cart-detail">
                                                <a class="remove" href="#"><i class="fa fa-times-circle"></i></a>
                                                <a href="#" class="edit-btn"><img src="{{URL::asset("img/btn_edit.gif")}}" alt="Edit Button" /></a>
